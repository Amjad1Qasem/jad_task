...
abstract class AppColors {
  ...
  static const primaryGreen = Color(0xff00953A);
  static const secondaryGreen = Color(0xff3BA76F);
  static const primaryBlue = Color(0xff004A97);
  static const secondaryBlue = Color(0xff396788);
  static const darkGreen = Color(0xff095B31);
  ...
  static final backgroundGradientcategory = [
    ...
    const Color(0xff69FFB2).withOpacity(0.1),
  ];
}
